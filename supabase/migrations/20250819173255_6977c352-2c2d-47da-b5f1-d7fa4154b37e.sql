...
-- Update storage bucket name and create images bucket
...
ON storage.objects 
FOR INSERT 
WITH CHECK (bucket_id = 'images' AND public.get_user_role(auth.uid()) = 'admin');

CREATE POLICY "Admins can update images" 
ON storage.objects 
FOR UPDATE 
USING (bucket_id = 'images' AND public.get_user_role(auth.uid()) = 'admin');
